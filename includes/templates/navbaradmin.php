     ...
     <div class="container">
            ...
            <div class="row">
                ...
                if(isset($_SESSION['useradmin'])){
					...
					echo'<div class="user-login">' . '<a class=" btn user-btn" href="logout.php">تسجيل الخروج</a>' . ' ' . $_SESSION['nameadmin']. '<span class="user-login-span"> مـــرحـبـا </span>'.'</div>'; 
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       <li><a class="hvr-push" href="indexadmin.php">الرئيسية<span class="sr-only">(current)</span></a></li>
